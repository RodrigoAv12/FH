!(function(t, e) {
  ...
  return (function(t) {
    ...
    function(t, e, a) {
      ...
      e.a = {
        name: "form-wizard",
        components: { WizardButton: n.a, WizardStep: i.a },
        props: {
          id: { type: String, default: "fw_" + new Date().valueOf() },
          title: { type: String, default: "Awesome Wizard" },
          subtitle: {
            type: String,
          ...
          errorColor: { type: String, default: "#8b0000" },
        ...
        computed: {
          ...
          progress: function() {
            return this.activeTabIndex > 0
              ? this.stepPercentage * (2 * this.activeTabIndex + 1)
              : this.stepPercentage;
          }
        },
        methods: {
          ...
          addTab: function(t) {
            ...
            (t.tabId = "" + t.title.replace(/ /g, "") + e),
              this.tabs.splice(e, 0, t),
              e < this.activeTabIndex + 1 &&
                ((this.maxStep = e),
                this.changeTab(this.activeTabIndex + 1, e));
          },
          removeTab: function(t) {
            var e = this.tabs,
              a = e.indexOf(t);
            a > -1 &&
              (a === this.activeTabIndex &&
          ...
          navigateToTab: function(t) {
            ...
            if (t <= this.maxStep) {
              var n = function n() {
                a && t - e.activeTabIndex > 1
                  ? (e.changeTab(e.activeTabIndex, e.activeTabIndex + 1),
                    e.beforeTabChange(e.activeTabIndex, n))
                  : (e.changeTab(e.activeTabIndex, t),
                    e.afterTabChange(e.activeTabIndex));
              };
              a
                ? this.beforeTabChange(this.activeTabIndex, n)
                : (this.setValidationError(null), n());
            }
          ...
          nextTab: function() {
            var t = this,
              e = function() {
                t.activeTabIndex < t.tabCount - 1
                  ? (t.changeTab(t.activeTabIndex, t.activeTabIndex + 1),
                    t.afterTabChange(t.activeTabIndex))
                  : t.$emit("on-complete");
              };
          ...
          setValidationError: function(t) {
            (this.tabs[this.activeTabIndex].validationError = t),
              this.$emit("on-error", t);
          },
          validateBeforeChange: function(t, e) {
            var a = this;
            if ((this.setValidationError(null), Object(r.c)(t)))
              this.setLoading(!0),
                t
                  .then(function(t) {
                    a.setLoading(!1);
          ...
          executeBeforeChange: function(t, e) {
            this.$emit("on-validate", t, this.activeTabIndex),
              t
                ? e()
          ...
          changeTab: function(t, e) {
            ...
            return (
              n && (n.active = !1),
              i && (i.active = !0),
              a && this.activeTabIndex !== e && this.emitTabChange(t, e),
          ...
          initializeTabs: function() {
            this.tabs.length > 0 &&
              ...
              this.startIndex < this.tabs.length
                ? this.activateTabAndCheckStep(this.startIndex)
                : window.console.warn(
                    "Prop startIndex set to " +
                      this.startIndex +
    ...
    function(t, e, a) {
      ...
      e.a = {
        name: "wizard-step",
        props: {
          tab: { type: Object, default: function() {} },
          transition: { type: String, default: "" },
        ...
        computed: {
          ...
          stepTitleStyle: function() {
            return {
              color: this.tab.validationError
                ? this.tab.errorColor
                : this.tab.color
            };
          },
    ...
    function(t, e, a) {
      ...
      e.a = {
        ...
        props: {
          ...
          additionalInfo: { type: Object, default: function() {} }
        },
    ...
    function(t, e, a) {
      ...
      var o = {
        install: function(t) {
          t.component("form-wizard", n.a),
            t.component("tab-content", i.a),
            t.component("wizard-button", r.a),
            t.component("wizard-step", s.a);
        }
      };
    ...
    function(t, e, a) {
      ...
      var n = function() {
          var t = this,
            e = t.$createElement,
            a = t._self._c || e;
          return a("li", { class: { active: t.tab.active } }, [
            a(
              "a",
              {
                class: { disabled: !t.tab.checked },
              ...
              [
                a(
                  "div",
                  {
                    ...
                    style: [
                      t.tab.checked ? t.stepCheckedStyle : {},
                      t.tab.validationError ? t.errorStyle : {}
                    ],
                    attrs: {
                      role: "tab",
                  ...
                  [
                    a(
                      "transition",
                      { attrs: { name: t.transition, mode: "out-in" } },
                      [
                        t.tab.active
                          ? a(
                              "div",
                              {
                                ...
                                style: [
                                  t.tab.active ? t.iconActiveStyle : {},
                                  t.tab.validationError ? t.errorStyle : {}
                                ]
                              },
                              [
      ...
      var n = function() {
          ...
          return a(
            "div",
            {
              ...
              class: [t.stepSize, { vertical: t.isVertical }],
              attrs: { id: t.id ? t.id : "" },
              on: {
                keyup: [
                  function(e) {
                    return "button" in e || !t._k(e.keyCode, "right", 39, e.key)
                      ? "button" in e && 2 !== e.button
                        ? null
                        : void t.focusNextTab(e)
                      : null;
                  },
                  function(e) {
                    return "button" in e || !t._k(e.keyCode, "left", 37, e.key)
                      ? "button" in e && 0 !== e.button
                        ? null
                        : void t.focusPrevTab(e)
                      : null;
                  }
                ]
              }
            ...
            [
              t.$slots.title
                ? a(
                    ...
                    [
                      t._t("title", [
                        a("h4", { staticClass: "wizard-title" }, [
                          t._v(t._s(t.title))
                        ]),
                        t._v(" "),
                        a("p", { staticClass: "category" }, [
                ...
                : t._e(),
              t._v(" "),
              a("div", { staticClass: "wizard-navigation" }, [
                t.isVertical
                  ? t._e()
                  : a("div", { staticClass: "wizard-progress-with-circle" }, [
                      a("div", {
                ...
                a(
                  ...
                  [t._t("default", null, null, t.slotProps)],
                  2
                )
              ]),
              t._v(" "),
