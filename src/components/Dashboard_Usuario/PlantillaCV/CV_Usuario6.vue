<template>
	...
	<div id="contact-info">
		<div  class="links" style="margin-left:0px !important;">
			...
			<div class="col2"><a href="" target="_blank">admin@greepit.com</a></div>
		</div>
		...
		<div  class="links">
			...
			<div class="col2"><a href="" target="_blank">esarfraz</a></div>
		</div>
		
		
		<div  class="links">
			<div class="col1">Blog</div>
			<div class="col2"><a href="" target="_blank" title="Open source web development resources">greepit.com</a></div>
		</div>
		
		
		<div class="links">
			<div class="col1">Portfolio</div>
			<div class="col2"><a href="" target="_blank">esarfraz.com</a></div>
		</div>
		...
		<div class="section">
			...
			<div id="skip-to-content03" class="scroll-links">
                <a id="to-experience" class="hand-cursor">Skip to Experience</a>
			</div>
		...
		<div class="section">
			...
			<div id="skip-to-content01" class="scroll-links">
                <a id="bto-education" class="hand-cursor">Back to Education</a> &nbsp; | &nbsp;
				<a id="to-skills" class="hand-cursor">Skip to Skills</a>
			</div>
			...
			<div class="section-body">
				<div class="item-template">
					<div>
						<h2><a href="" target="_blank" title="Open source web development resources">greepit.com</a></h2>
				...
				<p>Greepit is an ever growing blog known for best open source <a href="" class="hidden" title="web development resources">web development resources</a> for designers and developers. This Inspirational Resource site attracts a wide variety of gurus from the IT industry ranging from SEO experts to Project Managers.</p>
				
				
				<div class="item-template">
					<div>
						<h2><a href="" target="_blank">speckyboy.com</a></h2>
				...
				<div class="item-template">
					<div>
						<h2><a href="" target="_blank">thelovelyplants.com</a></h2>
				...
				<div class="item-template">
					<div>
						<h2><a href="" target="_blank">tekpages.net</a></h2>
						<span class="text-small">2010</span>
					</div>
		...
		<div class="section">
			...
			<div id="skip-to-content02" class="scroll-links">
                <a id="bto-experience" class="hand-cursor">Back to Experience</a>
			</div>
			...
			<div class="section-body">
				...
				<div class="item-template-lessmargin last-item">
					<div class="skill-name">
						<h2>Thanking everyone!</h2>
						<div class="text-small first">Experience - ~29 years </div><br />
						<div class="text-small">Last Used - Just Used :)</div>
					</div>
					<div class="skill-rating">100%</div>
				</div>
		</div>
		
		<div id="go-top">
			<div id="nav_up" class="hand-cursor">
				<img src="https://avataaars.io/?avatarStyle=Transparent&topType=ShortHairShortCurly&accessoriesType=Prescription02&hairColor=Black&facialHairType=Blank&clotheType=Hoodie&clotheColor=White&eyeType=Default&eyebrowType=DefaultNatural&mouthType=Default&skinColor=Light" alt="Go to Top" />
			</div>
		</div>
</div>
...
body{ font-family:Arial, Helvetica, sans-serif;  font-size:15px; color:#4D4D4D;}
#wrapper{margin:20px auto; width:999px; background:#4D4D4D }
.clear{clear:both;}
...
.section-title{ background-repeat:no-repeat; width:171px; height:41px; float:left;}
...
.your-details ul li{padding:9px 10px 7px 40px; display:inline; background-repeat:no-repeat; }
