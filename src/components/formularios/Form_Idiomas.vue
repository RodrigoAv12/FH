      ...
      >
        <v-row justify="center" align="center">
          <p style="font-family: 'Roboto Mono', monospace;">
            ...
            <br />A2: Nivel elemental. <br />B1: Nivel intermedio. <br />B2:
            Nivel intermedio alto. <br />C1: Nivel avanzado. <br />C2: Experto.
          </p>
        </v-row>
      </v-col>
    </v-row>
